...
"""
Python Function Challenges - The Scholar's Path
...
Save your changes, then run the program in your terminal (python scholars_path.py)
...
2. Edit and save your code in scholars_path.py.
